...
class TestPasswordGenerator(unittest.TestCase):
    ...
    def test_generate_password_length_over_twenty_five(self):
        ...
        with self.assertRaises(ValueError):
            passwordGenerator.generate_password(26)
    ...
    def test_generate_password_length_negative(self):
        ...
        with self.assertRaises(ValueError):
            passwordGenerator.generate_password(-1)
    ...
    def test_generate_password_lowercase(self):
        ...
        password = passwordGenerator.generate_password(25, use_lowercase=True, use_uppercase=False)
        self.assertTrue(any(c.islower() for c in password))

    def test_generate_password_uppercase(self):
        # Vérifiez que le mot de passe contient des lettres majuscules
        password = passwordGenerator.generate_password(25, use_lowercase=False, use_uppercase=True)
        self.assertTrue(any(c.isupper() for c in password))

    def test_generate_password_digits(self):
        # Vérifiez que le mot de passe contient des chiffres
        password = passwordGenerator.generate_password(25, use_digits=True, use_symbols=False)
        self.assertTrue(any(c.isdigit() for c in password))

    def test_generate_password_symbols(self):
        # Vérifiez que le mot de passe contient des symboles
        password = passwordGenerator.generate_password(25, use_symbols=True, use_lowercase=False)
    ...
    def test_generate_password_no_character_selected(self):
        ...
        with self.assertRaises(ValueError):
            passwordGenerator.generate_password(25, use_lowercase=False, use_uppercase=False, use_digits=False, use_symbols=False)

    def test_generate_password_hash_sha256(self):
        # Vérifiez que le mot de passe généré est correctement haché
        password = passwordGenerator.generate_password(25, use_hash="SHA-256")
        self.assertEqual(len(password), 64)
    
    def test_generate_password_hash_md5(self):
        # Vérifiez que le mot de passe généré est correctement haché
        password = passwordGenerator.generate_password(25, use_hash="MD5")
